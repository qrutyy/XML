####  Темы (предварительные) к экзамену по компиляторам (осень-зима 2026-26)

1. Общая архитектура компилятора. Frontend, Middleend, Backend и их составные части.
   Whole program optimization, её преимущества и недостатки. ILP (пример со сложением массива)
...
1. Борьба с избыточностью значений. Устранение избыточности в циклах.
1. Оптимизации CFG. Критические рёбра. Постдоминирование. Слияние возвращённых значений, удаление лишних рёбер и переходов. Jump threading. Каноническая форма циклов, версионирование.
1. Куча и сборка мусора. Различные подходы к сборке мусора. Копирующий сбощик и его реализация в ДЗ (алгоритм).
1. Система типов Хиндли-Милнера. Язык типов и правила вывода. Let-полиморфизм. Эффективный вывод типов с помощью уровней и связь с GC.
